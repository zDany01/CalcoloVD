...
namespace CalcoloVelocitaDownload
{
    public partial class GUIForm : Form
    {
        ...
        private static string ElaboraTempo(decimal secondi)
        {
            ...
            int minuti = (isec / 60); isec =Convert.ToInt32(secondi % 86400 % 3600 % 60); //usato nel caso in cui il numero superi {sec}.5 è quindi viene automaticamente arrotondato a {sec}++ grazie al convert.ToInt32, non provare a semplificare nella parentesi apparente bug?
